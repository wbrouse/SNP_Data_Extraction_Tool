...
#To run script the script name and path must be called first, the ScanFold-Scan log.out file and path must be called second, and the location of the SNP must be entered last
#Results may be printed to the user interface or piped into a simple text file by using "> outfilename.txt" 
